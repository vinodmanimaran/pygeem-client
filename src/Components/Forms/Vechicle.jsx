...
const VehicleInsurance = () => {
  ...
  const handleSubmit = async () => {
    try {
      if (!formData.name || !formData.mobile || !formData.vehicle || !formData.place || !formData.district) {
...
<ApplyButton onClick={handleOpen} />
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <TextField fullWidth label="Vehicle" name="vehicle" value={formData.vehicle} onChange={handleChange} style={{marginBottom:"10px"}} />
